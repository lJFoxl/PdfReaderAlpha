...
using PdfSharp_net8_.iTextSharp.text.io;
...
namespace PdfSharp_net8_.iTextSharp.testutils {
        ...
        try {
            ...
            if (exitValue == 0) {
                ...
                if (exitValue == 0) {
                    ...
                    for (int i = 0; i < cnt; i++) {
                        CompareToolUtil.Copy(imageFiles[i].FullName, global::System.IO.Path.Combine(
                            tarGetDir.FullName, outPdfName + "-" + (i + 1) + "." + renderedImageExtension
                        ).ToString());
                        CompareToolUtil.Copy(cmpImageFiles[i].FullName, global::System.IO.Path.Combine(
