...
using PdfSharp_net8_.iTextSharp.text.pdf.collection;
using PdfSharp_net8_.iTextSharp.text.pdf.events;
using PdfSharp_net8_.iTextSharp.text.pdf.interfaces;
using PdfSharp_net8_.iTextSharp.text.pdf.intern;
using PdfSharp_net8_.iTextSharp.text.xml.xmp;
using PdfSharp_net8_.iTextSharp.xmp;
using PdfSharp_net8_.iTextSharp.xmp.options;
using PdfSharp_net8_.System.util;
using PdfSharp_net8_.System.util.collections;
            ...
            */
            virtual public void WriteCrossReferenceTable(Stream os, PdfIndirectReference root, PdfIndirectReference info, PdfIndirectReference encryption, PdfObject fileID, long prevxref) {
                ...
                if (writer.FullCompression) {
                    ...
                    global::System.Collections.IEnumerator i = xrefs.Keys;
                    i.MoveNext();
    ...
    */
    ...
    //  [M3] Images
        ...
        */
        ...
        public virtual TtfUnicodeWriter GetTtfUnicodeWriter() {
            if (ttfUnicodeWriter == null)
                ttfUnicodeWriter = new TtfUnicodeWriter(this);
            return ttfUnicodeWriter;
        }

        protected virtual XmpWriter CreateXmpWriter(MemoryStream baos, PdfDictionary info) {
            return new XmpWriter(baos, info);
        }

        protected virtual XmpWriter CreateXmpWriter(MemoryStream baos, IDictionary<String, String> info) {
            return new XmpWriter(baos, info);
        }
