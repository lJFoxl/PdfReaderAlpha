...
namespace PdfSharp_net8_.Helper.text.pdf.parser {
    ...
    public class PdfReaderContentParser {
        ...
        /**
         * Обрабатывает содержимое с указанного номера страницы, используя указанный прослушиватель.
         * Также позволяет регистрировать пользовательские операторы контента
