...
using PdfSharp_net8_.Helper.text.exceptions;
using PdfSharp_net8_.Helper.text.io;
using PdfSharp_net8_.Helper.text.log;
using PdfSharp_net8_.Helper.text.pdf.collection;
using PdfSharp_net8_.Helper.text.pdf.intern;
using PdfSharp_net8_.Helper.text.xml.xmp;
using PdfSharp_net8_.Helper.xmp;
using PdfSharp_net8_.Helper.xmp.options;
