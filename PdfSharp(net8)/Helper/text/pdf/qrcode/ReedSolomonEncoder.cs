...
namespace PdfSharp_net8_.Helper.text.pdf.qrcode {
    ...
    public sealed class ReedSolomonEncoder {
        ...
        public void Encode(int[] toEncode, int ecBytes) {
            ...
            global::System.Array.Copy(toEncode, 0, infoCoefficients, 0, dataBytes);
            ...
            global::System.Array.Copy(coefficients, 0, toEncode, dataBytes + numZeroCoefficients, coefficients.Length);
        }
    }
}
