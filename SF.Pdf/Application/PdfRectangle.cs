...
namespace SF.Pdf.Application {
    ...
    public class PdfRectangle : NumberArray {
        ...
        */
        virtual public Rectangle Rectangle => new Rectangle(Left, Bottom, Right, Top);
        ...
        */
        ...
        virtual public float Right => urx;
        ...
        virtual public float Bottom => lly;
        ...
        virtual public float Width => urx - llx;
        ...
        virtual public float Height => ury - lly;
         ...
         */
        virtual public PdfRectangle Rotate => new PdfRectangle(lly, llx, ury, urx, 0);
