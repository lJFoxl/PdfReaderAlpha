...
public class PdfEncodings
{
    ...
    internal static Dictionary<string, IExtraEncoding> extraEncodings = new();
    ...
    public static byte[] ConvertToBytes(string text, string encoding)
    {
        ...
        extraEncodings.TryGetValue(encoding.ToLower(global::System.Globalization.CultureInfo.InvariantCulture), out extra);
        if (extra != null)
        {
    ...
    public static string ConvertToString(byte[] bytes, string encoding)
    {
        ...
        var nameU = encoding.ToUpper(global::System.Globalization.CultureInfo.InvariantCulture);
        Encoding enc = null;
    ...
    public static void AddExtraEncoding(string name, IExtraEncoding enc)
    {
        ...
        { // This serializes concurrent updates
            Dictionary<string, IExtraEncoding> newEncodings = new(extraEncodings);
    ...
    {
        private static IntHashtable c2b = new();
    ...
    private class SymbolConversion : IExtraEncoding
    {
        ...
        private static IntHashtable t1 = new();
        private static IntHashtable t2 = new();
        ...
        virtual public byte[] CharToByte(char char1, string encoding)
        {
            var v = (byte)translation[(int)char1];
            if (v != 0)
                return new byte[] { v };
            else
                return new byte[0];
