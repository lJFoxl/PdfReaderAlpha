...
namespace SF.Pdf.Application {
    ...
    public abstract class BaseFont {
        ...
        */    
        ...
        virtual public List<int[]> SubsetRanges => subsetRanges;
        ...
        */
        ...
        protected static Dictionary<string, BaseFont> fontCache = new();
    
        /** list of the 14 built in fonts. */
        protected static Dictionary<string, PdfName> BuiltinFonts14 = new();
        ...
        */
        virtual public float GetWidthPointKerned(string text, float fontSize) {
            var size = (float)GetWidth(text) * 0.001f * fontSize;
            if (!HasKernPairs())
                return size;
        ...
        */
         ...
         */    
        virtual public int[] Widths => widths;

        /** Gets the array with the names of the characters.
         * @return the array with the names of the characters
         */    
        virtual public string[] Differences => differences;

        /** Gets the array with the unicode characters.
         * @return the array with the unicode characters
         */    
        virtual public char[] UnicodeDifferences => unicodeDifferences;
        ...
        virtual public bool ForceWidthsOutput {
            set => this.forceWidthsOutput = value;
        ...
        virtual public bool DirectTextToByte {
            set => this.directTextToByte = value;
            ...
            if(xobj != null){
                if (visitedResources.AddAndCheck(xobj)){
                    foreach (var key in xobj.Keys) {
                        var po = xobj.GetDirectObject(key);
