...
namespace SF.Pdf.Application
{
    ...
    public class Properties
    {
        ...
        virtual public int Count => _col.Count;
        ...
        virtual public Dictionary<string,string>.KeyCollection Keys => _col.Keys;
        ...
        virtual public void Load(Stream inStream) {
            ...
            var inp = new StreamReader(inStream, Encoding.GetEncoding(1252));
            while (true) {
                // Get next line
