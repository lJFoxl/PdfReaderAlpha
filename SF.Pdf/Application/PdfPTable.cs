    ...
    */
    ...
    public class PdfPTable : ILargeElement, ISpaceable, IAccessibleElement
    {
        ...
        */
        ...
        virtual public PdfPCell DefaultCell => defaultCell;
        ...
        */
        ...
        virtual public int Size => rows.Count;

        /** Gets the total height of the table.
        * @return the total height of the table
        */

        virtual public float TotalHeight => totalHeight;
        ...
        */
        ...
        virtual public int NumberOfColumns => relativeWidths.Length;
        ...
        */
        ...
        virtual public IList<Chunk> Chunks => new List<Chunk>();
        ...
        */
        ...
        virtual public int Type => Element.PTABLE;
        ...
        */
        ...
        virtual public List<PdfPRow> Rows => rows;
        ...
        */
        ...
        virtual public float[] AbsoluteWidths => absoluteWidths;
        ...
        */
        ...
        virtual public FittingRows GetFittingRows(float availableHeight, int startIdx) {
            ...
            if (startIdx > 0 && startIdx < rows.Count) {
                global::System.Diagnostics.Debug.Assert(GetRow(startIdx).GetCells()[0] != null); // top left cell of current page may not be null
            }
