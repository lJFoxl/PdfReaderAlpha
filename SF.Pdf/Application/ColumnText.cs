 ...
 */
    ...
    //    protected ArrayList chunks = new ArrayList();
         ...
         * @return the leading
         */
        virtual public float MultipliedLeading => multipliedLeading;
        ...
        */
        ...
        virtual public float ExtraParagraphSpace {
            ...
            set => this.extraParagraphSpace = value;
        }
         ...
         */
        virtual public int LinesWritten => this.linesWritten;
         ...
         * @since 5.0.3
         */
        virtual public float LastX => lastX;
         ...
         */    
        virtual public float Descender => descender;
        ...
        virtual public IList<IElement> CompositeElements => compositeElements;
