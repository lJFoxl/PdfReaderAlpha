...
namespace SF.Pdf.Application {
    ...
    public class Document : IDocListener, IAccessibleElement {
        ...
        */
        ...
        virtual public void AddDocListener(IDocListener listener) {
            ...
            if (listener is IAccessibleElement) {
                var ae = (IAccessibleElement)listener;
                ae.Role = this.role;
                ae.ID = this.id;
                if (this.accessibleAttributes != null) {
                    foreach (var key in this.accessibleAttributes.Keys)
        ...
        /// </summary>
        /// <value>an int</value>
        virtual public int PageNumber => this.pageN;
        ...
        */ 
        ...
        virtual public float LeftMargin => marginLeft;

        /// <summary>
        /// Return the right margin.
        /// </summary>
        /// <value>the right margin</value>
        virtual public float RightMargin => marginRight;

        /// <summary>
        /// Returns the top margin.
        /// </summary>
        /// <value>the top margin</value>
        virtual public float TopMargin => marginTop;

        /// <summary>
        /// Returns the bottom margin.
        /// </summary>
        /// <value>the bottom margin</value>
        virtual public float BottomMargin => marginBottom;

        /// <summary>
        /// Returns the lower left x-coordinate.
        /// </summary>
        /// <value>the lower left x-coordinate</value>
        virtual public float Left => pageSize.GetLeft(marginLeft);

        /// <summary>
        /// Returns the upper right x-coordinate.
        /// </summary>
        /// <value>the upper right x-coordinate.</value>
        virtual public float Right => pageSize.GetRight(marginRight);

        /// <summary>
        /// Returns the upper right y-coordinate.
        /// </summary>
        /// <value>the upper right y-coordinate.</value>
        virtual public float Top => pageSize.GetTop(marginTop);

        /// <summary>
        /// Returns the lower left y-coordinate.
        /// </summary>
        /// <value>the lower left y-coordinate.</value>
        virtual public float Bottom => pageSize.GetBottom(marginBottom);
        ...
        virtual public Rectangle PageSize => this.pageSize;
        ...
        virtual public string JavaScript_onLoad {
            get => this.javaScript_onLoad;

            set => this.javaScript_onLoad = value;
        }
        ...
        virtual public string JavaScript_onUnLoad {
            get => this.javaScript_onUnLoad;

            set => this.javaScript_onUnLoad = value;
        }
        ...
        virtual public string HtmlStyleClass {
            get => this.htmlStyleClass;

            set => this.htmlStyleClass = value;
        }
