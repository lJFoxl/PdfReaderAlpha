    ...
    public class PdfLayer : PdfDictionary, IPdfOCG {
        ...
        */    
        virtual public string Name {
            set {
                Put(PdfName.NAME, new PdfString(value, this.PdfObject.TEXT_UNICODE));
            }
        }
        ...
        */    
        virtual public void SetCreatorInfo(String creator, String subtype) {
            ...
            dic.Put(PdfName.CREATOR, new PdfString(creator, this.PdfObject.TEXT_UNICODE));
        ...
        */    
        virtual public void SetLanguage(String lang, bool preferred) {
            PdfDictionary usage = Usage;
            PdfDictionary dic = new PdfDictionary();
            dic.Put(PdfName.LANG, new PdfString(lang, this.PdfObject.TEXT_UNICODE));
            if (preferred)
        ...
        */    
        ...
        virtual public void SetUser(String type, String[] names) {
            ...
            foreach (String s in names)
                arr.Add(new PdfString(s, this.PdfObject.TEXT_UNICODE));
