    ...
    internal class Type1Font : BaseFont {
        ...
        */
        ...
        internal Type1Font(string afmFile, string enc, bool emb, byte[] ttfAfm, byte[] pfb, bool forceRead) {
            ...
            if (BuiltinFonts14.ContainsKey(afmFile)) {
                ...
                try {
                    ...
                    if (istr == null) {
                        var msg = MessageLocalization.GetComposedMessage("1.not.found.as.resource", afmFile);
        ...
        virtual public void Process(RandomAccessFileOrArray rf) {
            ...
            while ((line = rf.ReadLine()) != null) {
                ...
                var metrics = new Object[]{C, WX, N, B};
                if (C >= 0)
            ...
            while ((line = rf.ReadLine()) != null) {
                ...
                if (ident.Equals("KPX")) {
                    ...
                    var width = (int)float.Parse(tok.NextToken(), global::System.Globalization.NumberFormatInfo.InvariantInfo);
                    Object[] relates;
        ...
        public override PdfStream GetFullFontStream() {
            ...
            lock (lockObject) {
                RandomAccessFileOrArray rf = null;
                try {
                    var filePfb = fileName.Substring(0, fileName.Length - 3) + "pfb";
                    if (pfb == null)
                        rf = new RandomAccessFileOrArray(filePfb, true);
                    else
                        rf = new RandomAccessFileOrArray(pfb);
                    var fileLength = (int)rf.Length;
        ...
        */
        public override bool SetKerning(int char1, int char2, int kern) {
            var first = GlyphList.UnicodeToName((int)char1);
            if (first == null)
                return false;
            var second = GlyphList.UnicodeToName((int)char2);
            if (second == null)
                return false;
            Object[] obj;
            KernPairs.TryGetValue(first, out obj);
