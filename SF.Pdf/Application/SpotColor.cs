...
namespace SF.Pdf.Application
{
    ...
    public class SpotColor : ExtendedColor
    {
        ...
        virtual public PdfSpotColor PdfSpotColor => spot;

        virtual public float Tint => tint;

        public override bool Equals(object obj)
        {
            return obj is SpotColor && ((SpotColor)obj).spot.Equals(spot) && ((SpotColor)obj).tint == tint;
        }
