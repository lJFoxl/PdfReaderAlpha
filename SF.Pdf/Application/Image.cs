...
namespace SF.Pdf.Application
{
    ...
    /// </summary>
    /// <seealso cref="T:PdfSharp_net8_.iTextSharp.text.Element"/>
    /// <seealso cref="T:PdfSharp_net8_.iTextSharp.text.Rectangle"/>
    public abstract class Image : Rectangle, IIndentable, ISpaceable, IAccessibleElement, IAlternateDescription {
        ...
        */
        ...
        public static Image GetInstance(Uri url, bool recoverFromImageError) {
            Stream istr = null;
            var randomAccessSourceFactory = new RandomAccessSourceFactory();
            try {
        ...
        public static Image GetInstance(Stream s) {
            var a = StreamUtil.InputStreamToArray(s);
        ...
        */    
        ...
        virtual public void ScaleToFit(float fitWidth, float fitHeight) {
            ScalePercent(100);
            var percentX = (fitWidth * 100) / this.ScaledWidth;
            var percentY = (fitHeight * 100) / this.ScaledHeight;
        ...
        */
        virtual public float GetImageRotation() {
            var rot = (float) ((rotationRadians - initialRotation) % (2.0 * Math.PI));
            if (rot < 0) {
        ...
        virtual public byte[] RawData => rawData;
        ...
        virtual public float AbsoluteX => absoluteX;

        /// <summary>
        /// Returns the absolute Y position.
        /// </summary>
        /// <value>a position</value>
        virtual public float AbsoluteY => absoluteY;
        ...
        */
        ...
        /// </summary>
        /// <value>a value</value>
        virtual public float ScaledWidth => scaledWidth;

        /// <summary>
        /// Gets the scaled height of the image.
        /// </summary>
        /// <value>a value</value>
        virtual public float ScaledHeight => scaledHeight;
        ...
        virtual public int Colorspace => colorspace;
        ...
        /// </summary>
        /// <value>a value</value>
        virtual public float PlainWidth => plainWidth;

        /// <summary>
        /// Gets the plain height of the image.
        /// </summary>
        /// <value>a value</value>
        virtual public float PlainHeight => plainHeight;
        ...
        */
        ...
        virtual public bool ScaleToFitLineWhenOverflow {
            get => scaleToFitLineWhenOverflow;
        ...
        */
        virtual public float InitialRotation {
            get => initialRotation;
            set {
                var old_rot = rotationRadians - this.initialRotation;
