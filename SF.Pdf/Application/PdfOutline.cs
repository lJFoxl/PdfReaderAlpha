...
namespace SF.Pdf.Application {
    ...
    public class PdfOutline : PdfDictionary {
        ...
        virtual public PdfOutline Parent => parent;
         ...
         */
        virtual public PdfDestination PdfDestination => destination;
        ...
        virtual public string Title {
            ...
            set => Put(PdfName.TITLE, new PdfString(value, PdfObject.TEXT_UNICODE));
        }
