    ...
    public class PdfPCell : Rectangle, IAccessibleElement {
        ...
        */
        public PdfPCell(PdfPCell cell) : base(cell.llx, cell.lly, cell.urx, cell.ury) {
            ...
            image = this.Image.GetInstance(cell.image);
        ...
        * @return the leading
        */
        virtual public float Leading => column.Leading;

        /**
        * Gets the variable leading
        * @return the leading
        */
        virtual public float MultipliedLeading => column.MultipliedLeading;
        ...
        */
         ...
         */
        public float CachedMaxHeight => cachedMaxHeight;
        ...
        * @since    2.1.1
        */
        virtual public List<IElement> CompositeElements => column.compositeElements;
