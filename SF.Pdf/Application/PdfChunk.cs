...
namespace SF.Pdf.Application {
    ...
    public class PdfChunk {
        ...
        internal PdfChunk(Chunk chunk, PdfAction action) {
            ...
            var f = chunk.Font;
            var size = f.Size;
            if (size == Application.Font.UNDEFINED)
                size = 12;
            baseFont = f.BaseFont;
            //BaseFont bf = f.BaseFont;
            var style = f.Style;
            if (style == Application.Font.UNDEFINED) {
                style = Application.Font.NORMAL;
            }
            if (baseFont == null) {
            ...
            if (f.IsUnderlined()) {
                ...
                var unders = Utilities.AddToArray(obja, obj);
        ...
        */    
        ...
        internal float Width(string str) {
            ...
            {
                var cs = (float)GetAttribute(Chunk.CHAR_SPACING);
                width += str.Length * cs;
            }
            if (IsAttribute(Chunk.WORD_SPACING))
            {
                ...
                while ((idx = str.IndexOf(' ', idx + 1)) >= 0)
                    ++numberOfSpaces;
                var ws = (float)GetAttribute(Chunk.WORD_SPACING);
        ...
        */
        ...
        internal static TabStop GetTabStop(PdfChunk tab, float tabPosition)
        {
            ...
            {
                var tabInterval = (float)((object[])o)[0];
        ...
        virtual public bool ChangeLeading => changeLeading;


        virtual public float Leading => leading;
