...
namespace SF.Pdf.Application {
    ...
    /// <seealso cref="T:PdfSharp_net8_.iTextSharp.text.List"/>
    /// <seealso cref="T:PdfSharp_net8_.iTextSharp.text.Paragraph"/>
    public class ListItem : Paragraph {
        ...
        /// </summary>
        /// <value>a type</value>
        public override int Type => Element.LISTITEM;

        // methods

        public override Paragraph CloneShallow(bool spacingBefore) {
            var copy = new ListItem();
