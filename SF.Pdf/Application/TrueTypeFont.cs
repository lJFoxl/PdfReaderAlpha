...
namespace SF.Pdf.Application {
    ...
    public class TrueTypeFont : BaseFont {
        ...
        virtual public RandomAccessFileOrArray Rf => rf;

        /** The file name.
         */
        protected string fileName;

        virtual public string FileName => fileName;

        protected bool cff = false;

        virtual public bool Cff => cff;
        ...
        virtual public int DirectoryOffset => directoryOffset;
        ...
        */
        ...
        protected static string GetTTCName(string name) {
            var idx = name.ToLower(global::System.Globalization.CultureInfo.InvariantCulture).IndexOf(".ttc,");
            if (idx < 0)
                return name;
            else
        ...
        */    
        ...
        virtual protected void ReadGlyphWidths() {
            ...
            for (var k = 0; k < hhea.numberOfHMetrics; ++k) {
                ...
                var leftSideBearing = rf.ReadShort() * 1000 / head.unitsPerEm;
            }
        }
        ...
        internal Dictionary<int,int[]> ReadFormat4() {
            var h = new Dictionary<int,int[]>();
            var table_lenght = rf.ReadUnsignedShort();
            rf.SkipBytes(2);
        ...
        internal Dictionary<int,int[]> ReadFormat6() {
            var h = new Dictionary<int,int[]>();
            rf.SkipBytes(4);
            var start_code = rf.ReadUnsignedShort();
            var code_count = rf.ReadUnsignedShort();
        ...
        virtual public void AddRangeUni(Dictionary<int, int[]> longTag, bool includeMetrics, bool subsetp) {
            if (!subsetp && (subsetRanges != null || directoryOffset > 0)) {
                var rg = (subsetRanges == null && directoryOffset > 0) ? new int[]{0, 0xffff} : CompactRanges(subsetRanges);
        ...
        */
        ...
        public override string[] CodePagesSupported {
            get {
                var cp = (((long)os_2.ulCodePageRange2) << 32) + ((long)os_2.ulCodePageRange1 & 0xffffffffL);
                var count = 0;
                long bit = 1;
                for (var k = 0; k < 64; ++k) {
        ...
        */
        ...
        public int MaxGlyphId => maxGlyphId;
    }
}
