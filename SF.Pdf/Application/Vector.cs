...
namespace SF.Pdf.Application {
    ...
    public class Vector {
         ...
         */
        public float this[int index] => vals[index];
        ...
        virtual public Vector Cross(Matrix by){
            ...
            var x = vals[I1]*by[Matrix.I11] + vals[I2]*by[Matrix.I21] + vals[I3]*by[Matrix.I31];
            var y = vals[I1]*by[Matrix.I12] + vals[I2]*by[Matrix.I22] + vals[I3]*by[Matrix.I32];
            var z = vals[I1]*by[Matrix.I13] + vals[I2]*by[Matrix.I23] + vals[I3]*by[Matrix.I33];
         ...
         */
        virtual public float Length => (float)Math.Sqrt(LengthSquared);
         ...
         */
        virtual public float LengthSquared => vals[I1]*vals[I1] + vals[I2]*vals[I2] + vals[I3]*vals[I3];
