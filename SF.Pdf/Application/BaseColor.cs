...
namespace SF.Pdf.Application {
    ...
    public class BaseColor {
        ...
        public static readonly BaseColor LIGHT_GRAY = new(192, 192, 192);
        public static readonly BaseColor GRAY = new(128, 128, 128);
        public static readonly BaseColor DARK_GRAY = new(64, 64, 64);
         ...
         */
        virtual public int RGB => value;

        /**
         *
         * @return the value for red
         */
        virtual public int R => (RGB >> 16) & 0xFF;

        /**
         *
         * @return the value for green
         */
        virtual public int G => (RGB >> 8) & 0xFF;

        /**
         *
         * @return the value for blue
         */
        virtual public int B => (RGB >> 0) & 0xFF;

        /**
         *
         * @return the value for the alpha channel
         */
        virtual public int A => (RGB >> 24) & 0xff;
