...
namespace SF.Pdf.Application {
    ...
    /// <seealso cref="T:PdfSharp_net8_.iTextSharp.text.Anchor"/>
    public class Annotation : IElement {
        ...
        /// </summary>
        virtual public int Type => Element.ANNOTATION;
        ...
        /// </summary>
        /// <value>a type</value>
        virtual public int AnnotationType => annotationtype;
        ...
        /// </summary>
        /// <value>a reference</value>
        virtual public Dictionary<string, object> Attributes => annotationAttributes;
