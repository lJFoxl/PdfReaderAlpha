...
namespace SF.Pdf.Application {
    ...
    public class PdfNumber : PdfObject {
        ...
        virtual public int IntValue => (int) value;
        ...
        virtual public long LongValue => (long) value;
        ...
        virtual public double DoubleValue => value;

        virtual public float FloatValue => (float)value;
