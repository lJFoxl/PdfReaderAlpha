...
namespace SF.Pdf.Application {
    ...
    public class PdfSignature : PdfDictionary {
        ...
        virtual public string Name {
            set => Put(PdfName.NAME, new PdfString(value, PdfObject.TEXT_UNICODE));
        }
        ...
        virtual public string Location {
            set => Put(PdfName.LOCATION, new PdfString(value, PdfObject.TEXT_UNICODE));
        }

        virtual public string Reason {
            set => Put(PdfName.REASON, new PdfString(value, PdfObject.TEXT_UNICODE));
        }
        ...
        virtual public string Contact {
            set => Put(PdfName.CONTACTINFO, new PdfString(value, PdfObject.TEXT_UNICODE));
        }
    }
}
