...
namespace SF.Pdf.Application {
    ...
    public abstract class AbstractCMap {
        ...
        public static byte[] DecodeStringToByte(PdfString s) {
            var b = s.GetBytes();
            var br = new byte[b.Length];
            global::System.Array.Copy(b, 0, br, 0, b.Length);
            return br;
        }
