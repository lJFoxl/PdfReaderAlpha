    ...
    public class PdfLine {
        ...
        */
        ...
        internal PdfChunk Add(PdfChunk chunk) {
            ...
            if (chunk.IsTab()) {
                ...
                if (chunk.IsAttribute(Chunk.TABSETTINGS)) {
                    ...
                    var tabStopPosition = (float) tab[1];
        ...
        private void AddToLine(PdfChunk chunk) {
            ...
            if (tabStop != null && tabStop.Align == TabStop.Alignment.ANCHOR && float.IsNaN(tabStopAnchorPosition))
            {
                ...
                var anchorIndex = value.IndexOf(tabStop.AnchorChar);
                if (anchorIndex != -1)
                {
                    var subWidth = chunk.Width(value.Substring(anchorIndex));
        ...
        virtual public int Size => line.Count;
        ...
        internal int NumberOfSpaces {
            get
            {
                ...
                foreach (var pdfChunk in line)
                {
                    var tmp = pdfChunk.ToString();
        ...
        virtual public Chunk ListSymbol => listItem != null ? listItem.ListSymbol : null;
        ...
        virtual public float ListIndent => listItem != null ? listItem.IndentationLeft : 0;
         ...
         */
        virtual public bool NewlineSplit => newlineSplit && (alignment != Element.ALIGN_JUSTIFIED_ALL);
         ...
         */
        virtual public float OriginalWidth => originalWidth;
        ...
        internal float[] GetMaxSize(float fixedLeading, float multipliedLeading) {
            ...
            for (var k = 0; k < line.Count; ++k) {
                ...
                if (chunk.IsImage()) {
                    var img = chunk.Image;
                    if (chunk.ChangeLeading) {
                        var height = chunk.ImageHeight + chunk.ImageOffsetY + img.SpacingBefore;
        ...
        */
        ...
        virtual public void Flush()
        {
            if (tabStop != null)
            {
                var textWidth = originalWidth - width - tabPosition;
