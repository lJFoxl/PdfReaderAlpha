...
namespace SF.Pdf.Application {
    ...
    /** This is a Chunk containing a newpage. */
        ...
        */
        ...
        /// </summary>
        /// <value>a type</value>
        virtual public int Type => Element.CHUNK;
        ...
        */    
        virtual public Chunk SetUnderline(BaseColor color, float thickness, float thicknessMul, float yPosition, float yPositionMul, int cap) {
            ...
            var unders = Utilities.AddToArray(old, obj);
	    ...
	    */
	    ...
	    virtual public float GetWordSpacing() {
		    if (attributes != null && attributes.ContainsKey(WORD_SPACING)) {
			    var f = (float)attributes[WORD_SPACING];
			    return f;
		    }
		    return 0.0f;		
	    }
        ...
        {
            var tabspace = new Chunk(spacing, true);
            return tabspace;
        }
        ...
        virtual public string GetTextExpansion() {
            var o = GetAccessibleAttribute(PdfName.E);
            if (o is PdfString)
