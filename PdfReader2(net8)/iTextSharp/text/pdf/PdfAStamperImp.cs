...
using PdfReader2_net8_.iTextSharp.text.pdf.interfaces;
using PdfReader2_net8_.iTextSharp.text.pdf.intern;
using PdfReader2_net8_.iTextSharp.text.xml.xmp;
using PdfSharp_net8_.iTextSharp.text;
...
using PdfSharp_net8_.iTextSharp.xmp.impl;
using PdfSharp_net8_.iTextSharp.xmp.properties;

namespace PdfReader2_net8_.iTextSharp.text.pdf {
    /**
    ...
    public class PdfAStamperImp : PdfStamperImp {
        ...
        public override TtfUnicodeWriter GetTtfUnicodeWriter() {
